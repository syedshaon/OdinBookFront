    ...
    !authState.isLoggedIn && (
      <section className="text-gray-600 body-font bg-gray-100 h-screen flex items-center ">
        ...
        <div className="container xl:px-32 px-5  mx-auto flex flex-wrap items-center  ">
          ...
          <form onSubmit={handleSignInSubmit} className="lg:w-2/6 md:w-1/2 bg-white shadow-lg rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            ...
            <p className="text-sm text-blue-500 mt-3 text-center pt-4">Forgotten password?</p>
            <hr className="my-3" />

            <button onClick={() => navigateTo("/get-reset-password")} className="cursor-pointer text-white  border-0 py-2 px-8 focus:outline-none font-medium  rounded text-xl bg-green-500">
              Reset Password
            </button>
            {/* Get Verififcation Email */}

            <p className="text-sm text-blue-500 mt-3 text-center pt-4">Didn't get Verification Email?</p>
            <hr className="my-3" />

            <button onClick={() => navigateTo("/get-verification-email")} className="cursor-pointer text-white  border-0 py-2 px-8 focus:outline-none font-medium  rounded text-xl bg-green-950 ">
