...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white h-max   w-full shadow grid   items-center content-between   grid-cols-2  grid-rows-2 gap-2 md:gap-0 md:grid-rows-1 md:grid-cols-4 fixed top-0 left-0 z-50 border-b">
      {/* LEFT NAV */}
